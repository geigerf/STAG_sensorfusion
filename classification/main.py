...
parser = argparse.ArgumentParser(description='Touch-Classification with sensorfusion.',
                        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--dataset', default=('/scratch1/msc20f10/data/3kOhm_FB/'
                                          + 'data_MT_FabianGeiger_4sess.mat'),
...
# Parameters for the IMU feature extraction network
accel_only = True
if accel_only:
    imu_in = 3
else:
...
class Trainer(object):
    ...
    def loadDatasets(self, split='train', shuffle=True,
        ...
        return torch.utils.data.DataLoader(
            CustomDataLoader(self.data[split][0], self.data[split][1],
                             augment=(split=='train'), split=split,
    ...
    def run(self):
        ...
        savedir = '/home/msc20f10/Python_Code/results/stag_sensorfusion/'
    ...
    def initModel(self):
        ...
        self.model = Model(numClasses=nClasses, inplanes=args.nfilters,
                           dropout=args.dropout, imu_in=imu_in, imu_out=imu_out,
...
if __name__ == "__main__":
    ...
    data_set = load_data(filename=metaFile, kfold=kFoldCV, seed=seed,
                         undersample=undersample, split=split, accel_only=accel_only)
